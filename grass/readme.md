# GRASS GIS example batch jobs for Roihu supercomputer
...
* In these examples temporary location is used, in many cases it is better to use permanend GRASS mapset and location. 
