#####################
#### Get Lidar file names as a function
#####################
lidar_files_taito <- function(f_poly){
  # Get lidar file names intersecting with given polygon
  # Note that in this example only year 2013 lidar index is used
  
  library(raster)
  
  # The lidar_index to be used
