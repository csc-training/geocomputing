...
```{r  }
LASfile <- "/wrk/your-username-here/R_lidar_2019/r_lidar_data/mml/laserkeilaus/2008_17/2017/T522/1/T5224G2_1.laz"
las <- readLAS(LASfile)
print(las)
```
...
There is a ready dataset with 6 las files in `/wrk/your-username-here/R_lidar_2019/r_lidar_data/las_subset`, including a text file with the list of las files that will be used `lasfiles.txt`.
