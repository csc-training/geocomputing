...
* The input NLS 10m DEM is already available in **Roihu's GIS data folder** : `/dataset/project_2019680/mml/dem10m/2019/` If you want to preview the files with [QGIS](https://docs.csc.fi/apps/qgis/), open one or a few DEM files from [mapsheets.txt](mapsheets.txt) file. For seeing all of Finland you can open `/dataset/project_2019680/mml/dem10m/dem10m_hierarchical.vrt`.
