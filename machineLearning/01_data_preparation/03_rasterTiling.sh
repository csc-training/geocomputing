...
tar -czvf spruce.tar tiles/image_training_tiles_650 label_tiles_650
tar -czvf forest.tar tiles/image_training_tiles_650 labels_all_classes_tiles_650
tar -czvf spruce_prediction.tar tiles/image_prediction_tiles_512
